...
const items = [
  ...
  const skills = [
    { name: 'LEADERSHIP', icon: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTUE5b8cLvdJfkQARtvnEIT0mrPNRxEWQPehA&s' },   
    { name: 'PERSONALITY DEVELOPMENT', icon: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRlX9o7HGdmVAs312juYX5qlPEwgBDkDZVhmg&s' },
    { name: 'TIME MANAGEMENT', icon: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRx8VTX2g5fTzJwJEIOnzTLctdbVaDCdu0W-g&s' },
    { name: 'COMMUNICATION SKILLS', icon: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR4QvaGMi7hNbSDIUktU4kNRpE7HMtAbTvNdA&s' },
    { name: 'PRESENTATION SKILLS', icon: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTcoDCcjT720OYS6Tt2JIdRNt5ttj8ZwfszvQ&s' },
    { name: 'MEETING SKILLS', icon: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRNM_xTkBeeOO63reGtc6XbMFZV9fHLtR8iZQ&s' },
  ];
    ...
    <Container maxWidth="lg" sx={{ py: { xs: 3, md: 5 } }}>
      <Grid container alignItems="center" spacing={5}>
        <Grid item xs={12} md={6}>
          <Typography variant="h3" gutterBottom sx={{marginBottom:'1.5rem',fontSize:{ xs: '2rem', md: '3rem' },lineHeight:'3rem',fontWeight:'800',color:'rgb(7 7 6)'}}>
          Welcome to Our Management Development Program
          </Typography>
          <Typography variant="body1" paragraph sx={{marginBottom:'2rem',fontSize:{ xs: '14px', md: '16px' },fontWeight:'500'}}>
        ...
        <Grid item xs={12} md={6}>
          <Box
            ...
            src="https://www.fusion-institute.com/_next/image?url=%2Fimg%2Fcoporate%2Fmanage1.jpg&w=1080&q=75"
          />
        </Grid>
      </Grid>
    </Container>
...
<Grid container alignItems="center" spacing={5}>
  <Grid item xs={12} md={6}>
    <Typography variant="h4" gutterBottom sx={{fontSize:{ xs: '24px', md: '30px' },fontWeight:'700',color:'rgb(7 7 6)'}}>
    Unlock Leadership Potential with Our Management Development Program
    </Typography>
    <Typography variant="body1" paragraph sx={{fontSize:{ xs: '16px', md: '18px' },color:'rgb(7 7 6)'}}>
    ...
    <Button variant="contained" sx={{color:'rgb(254 254 254)',fontSize:{ xs: '16px', md: '18px' },padding: { xs: '0.5rem 1rem', md: '0.75rem 2rem' },backgroundColor:'rgb(219 173 77)',borderRadius:'0.375rem'}}>
      About us
    </Button>
  </Grid>
  <Grid item xs={12} md={6}>
    <Box component="img" sx={{width: '100%', borderRadius: 2, boxShadow: 3,height:{xs:'auto',md:'400px'}}}
      ...
      src="https://www.fusion-institute.com/_next/image?url=%2Fimg%2Fcoporate%2Fcorporate2.jpg&w=640&q=75" 
    />
  </Grid>
</Grid>
</Container>

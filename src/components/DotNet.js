...
const  DotNet = () => {
    const syllabusFile="../Syllabus/Dot_Net_Development.pdf";
    const handleDownload=()=>{
        const link = document.createElement('a');
        link.href = syllabusFile;
        link.download = 'Dot_Net_Development.pdf';
        link.click();
    };
  ...
  return (
    ...
    <section id='course'>
            ...
            <div className='syllabus_img'>
                <img src='https://www.fusion-institute.com/_next/image?url=https%3A%2F%2Fres.cloudinary.com%2Fdu45ucceq%2Fimage%2Fupload%2Fv1716961880%2FFusionCourseImage%2Fdotnet_romnk1.jpg&w=640&q=75' alt='Dot Net Development'></img>
            </div>

            <div className='Vertical_line' />

            <div className='syllabus_desc'>
                <h1>What is Dot Net Development?</h1>
            <p>.NET Development involves building applications using the .NET framework, a comprehensive and versatile platform created by Microsoft. .NET developers work on developing, deploying, and maintaining software applications for web, desktop, mobile, and cloud environments. Mastering .NET development enables professionals to create robust, scalable, and high-performance applications. With a deep understanding of both the framework and associated tools, .NET developers can optimize application performance, enhance user experiences, and streamline 
                the development process, making them valuable assets in the software development industry.</p>
                <Link to="/demo">
            ...
            <div className='tools'>
                ...
                <div className='tools1'>
                    <div className='tools_desc'>
                        <TaskAltOutlinedIcon /><span>Visual Studio</span>
                    </div>
                    </div>

                    <div className='tools1'>
                    <div className='tools_desc'>
                        <TaskAltOutlinedIcon /><span>.NET SDK</span>
                </div>
                </div>
                ...
                <div className='tools1'>
                    <div className='tools_desc'>
                        <TaskAltOutlinedIcon /><span>NuGet</span>
                </div>
                </div>

                <div className='tools1'>
                    <div className='tools_desc'>
                        <TaskAltOutlinedIcon /><span>SQL Server Management Studio (SSMS)</span>
                </div>
                </div>

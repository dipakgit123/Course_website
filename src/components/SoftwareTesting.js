...
const  SoftwareTesting= () => {
    const syllabusFile="../Syllabus/Software_Testing.pdf";
    const handleDownload=()=>{
        const link = document.createElement('a');
        link.href = syllabusFile;
        link.download = 'Software_Testing.pdf';
        link.click();
    };
  ...
  return (
    ...
    <section id='course'>
            ...
            <div className='syllabus_img'>
                <img src='https://www.fusion-institute.com/_next/image?url=https%3A%2F%2Fres.cloudinary.com%2Fdu45ucceq%2Fimage%2Fupload%2Fv1716961944%2FFusionCourseImage%2FsoftwareTesting_ya0l7s.jpg&w=640&q=75' alt='Software Testing'></img>
            </div>
            ...
            <p>Software Testing is a critical phase in the software development lifecycle, involving the verification and validation of software applications to ensure they meet quality standards and functional requirements. Software testers work on identifying defects, bugs, and issues in software applications through various testing techniques and methodologies. Mastering software testing allows professionals to improve the reliability, performance, and usability of software products, thereby enhancing user satisfaction and minimizing business risks. Software testing is essential for companies looking 
                to deliver high-quality software solutions that meet customer expectations and industry standards.</p>
                <Link to="/demo">
            ...
            <div className='tools'>
                ...
                <div className='tools1'>
                    <div className='tools_desc'>
                        <TaskAltOutlinedIcon /><span>Selenium</span>
                    </div>
                    </div>

                    <div className='tools1'>
                    <div className='tools_desc'>
                        <TaskAltOutlinedIcon /><span>Jest</span>
                </div>
                </div>
        ...
        <div className='requirement'>
            ...
            <div className='skills'>
                ...
                <div className='subskills'>
                    ...
                    <h3>No prior software testing skills needed.</h3>
                    </div>
                </div>
            </div>
            ...
            <div className='skills'>
                ...
                <div className='subskills'>
                    <div className='subskills1'>
                    <h3>No prior manual testing knowledge required</h3>
                    </div>
                </div>
            </div>

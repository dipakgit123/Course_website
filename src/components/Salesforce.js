...
const  Salesforce = () => {
    const syllabusFile="../Syllabus/Salesforce.pdf";
    const handleDownload=()=>{
        const link = document.createElement('a');
        link.href = syllabusFile;
        link.download = 'Salesforce.pdf';
        link.click();
    };
  ...
  return (
    ...
    <section id='course'>
            ...
            <div className='syllabus_img'>
                <img src='https://www.fusion-institute.com/_next/image?url=https%3A%2F%2Fres.cloudinary.com%2Fdu45ucceq%2Fimage%2Fupload%2Fv1716961924%2FFusionCourseImage%2Fsalesforce_y8f6ar.jpg&w=640&q=75' alt='Salesforce'></img>
            </div>
            ...
            <p>Salesforce is a cloud-based customer relationship management (CRM) platform used by businesses to manage customer interactions, streamline sales processes, and drive growth. With Salesforce, organizations can track leads, manage opportunities, and automate sales tasks to improve efficiency and productivity. The platform offers a range of features, including customizable dashboards, reports, and workflows, to meet the unique needs of different industries and businesses. By leveraging Salesforce, companies can gain valuable insights into their customers, 
                enhance collaboration across teams, and deliver exceptional customer experiences.</p>
                <Link to="/demo">
            ...
            <div className='tools'>
                ...
                <div className='tools1'>
                    <div className='tools_desc'>
                        <TaskAltOutlinedIcon /><span>Salesforce Developer Console</span>
                    </div>
                    </div>

                    <div className='tools1'>
                    <div className='tools_desc'>
                        <TaskAltOutlinedIcon /><span>Salesforce CLI</span>
                </div>
                </div>

                <div className='tools1'>
                    <div className='tools_desc'>
                        <TaskAltOutlinedIcon /><span>Trailhead</span>
                </div>
                </div>

                <div className='tools1'>
                    <div className='tools_desc'>
                        <TaskAltOutlinedIcon /><span>VS Code</span>
                </div>
                </div>
    ...
    <section>
        ...
        <div className='skills'>
                ...
                <div className='subskills'>
                    ...
                    <h3>All you need is computer & Internet connection</h3>
                    </div>
                </div>
            </div>

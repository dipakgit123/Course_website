...
const JavaDevelopment = () => {
    const syllabusFile="../Syllabus/Java_Development.pdf";
    const handleDownload=()=>{
        const link = document.createElement('a');
        link.href = syllabusFile;
        link.download = 'Java_Development.pdf';
        link.click();
    };
  ...
  return (
    ...
    <section id='course'>
            ...
            <div className='syllabus_img'>
                <img src='https://www.fusion-institute.com/_next/image?url=https%3A%2F%2Fres.cloudinary.com%2Fdu45ucceq%2Fimage%2Fupload%2Fv1716961885%2FFusionCourseImage%2Fjava_n6s6mb.jpg&w=640&q=75' alt='Java Development'></img>
            </div>

            <div className='Vertical_line' />

            <div className='syllabus_desc'>
                <h1>What is Java Development?</h1>
            <p> Master Java development with hands-on projects and expert guidance. Dive into object-oriented programming, data structures, and multithreading. Build robust applications for diverse domains. Enhance proficiency with modern frameworks like Spring and Hibernate. 
                Whether beginner or experienced, Java mastery unlocks opportunities in software development.</p>
                <Link to="/demo">
            ...
            <div className='tools'>
                ...
                <div className='tools1'>
                    <div className='tools_desc'>
                        <TaskAltOutlinedIcon /><span>Java Development Kit</span>
                    </div>
                    </div>

                    <div className='tools1'>
                    <div className='tools_desc'>
                        <TaskAltOutlinedIcon /><span>Eclipse</span>
                </div>
                </div>
                ...
                <div className='tools1'>
                    <div className='tools_desc'>
                        <TaskAltOutlinedIcon /><span>DBMS</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div className='container_offering'>
            ...
            <div className='offering1'>
                <div className='course_offering'>
                    ...
                    <p><TaskAltOutlinedIcon />Course Duration: 6 Months</p>
                    <div className='vertical'/>

...
const  SAPFICO = () => {
    const syllabusFile="../Syllabus/SAP_FICO.pdf";
    const handleDownload=()=>{
        const link = document.createElement('a');
        link.href = syllabusFile;
        link.download = 'SAP_FICO.pdf';
        link.click();
    };
  ...
  return (
    ...
    <section id='course'>
            ...
            <div className='syllabus_img'>
                <img src='https://www.fusion-institute.com/_next/image?url=https%3A%2F%2Fres.cloudinary.com%2Fdu45ucceq%2Fimage%2Fupload%2Fv1716964505%2FFusionCourseImage%2FSAP_Fico_wdl8u6.jpg&w=640&q=75' alt='SAP FICO'></img>
            </div>

            <div className='Vertical_line' />

            <div className='syllabus_desc'>
                <h1>What is SAP FICO?</h1>
            <p>SAP FICO, short for Financial Accounting and Controlling, is a comprehensive module within the SAP ERP system designed for managing financial transactions, reporting, and analysis in businesses. It integrates various accounting functions such as general ledger accounting, accounts payable, accounts receivable, asset accounting, and controlling activities like cost accounting and profitability analysis. With SAP FICO, organizations can streamline their financial processes, gain insights into financial performance, and ensure regulatory compliance. It's an essential tool for finance professionals to manage financial data effectively 
                and support decision-making processes within the organization.</p>
                <Link to="/demo">
    ...
    <section>
        <div className='container_tool'>
            ...
            <div className='tools'>
                ...
                <div className='tools1'>
                    <div className='tools_desc'>
                        <TaskAltOutlinedIcon /><span>SAP FICO Configuration</span>
                </div>
                </div>

                <div className='tools1'>
                    <div className='tools_desc'>
                        <TaskAltOutlinedIcon /><span>SAP FICO Reports</span>
                </div>
                </div>

...
const  WebDevelopment = () => {
    const syllabusFile="../Syllabus/Full_Stack_Web_Development.pdf";
    const handleDownload=()=>{
        const link = document.createElement('a');
        link.href = syllabusFile;
        link.download = 'Full_Stack_Web_Development.pdf';
        link.click();
    };
  ...
  return (
    ...
    <section id='course'>
            ...
            <div className='syllabus_img'>
                <img src='https://www.fusion-institute.com/_next/image?url=https%3A%2F%2Fres.cloudinary.com%2Fdu45ucceq%2Fimage%2Fupload%2Fv1716963735%2FFusionCourseImage%2FwebDevelopment_bwxitq.jpg&w=640&q=75' alt='Full Stack Web Development'></img>
            </div>

            <div className='Vertical_line' />

            <div className='syllabus_desc'>
                <h1>What is Full Stack Web Development?</h1>
            <p>Full-Stack Web Development involves creating both the front-end and 
                back-end of web applications, providing a complete development solution. Full-stack developers work on user interfaces, server logic, database interactions, and API integrations, ensuring a seamless experience from the client side to the server side. Mastering full-stack web development allows professionals to build robust, scalable, and interactive web applications. By understanding both front-end and back-end technologies, full-stack developers can optimize performance, enhance user experience, and streamline the development process, 
                making them highly versatile and valuable in the tech industry.</p>
                <Link to="/demo">
            ...
            <div className='tools'>
                ...
                <div className='tools1'>
                    <div className='tools_desc'>
                        <TaskAltOutlinedIcon /><span>HTML/CSS, JavaScript, React.js</span>
                    </div>
                    </div>

                    <div className='tools1'>
                    <div className='tools_desc'>
                        <TaskAltOutlinedIcon /><span>MySQL, PostgreSQL, MongoDB</span>
                </div>
                </div>

                    <div className='tools1'>
                    <div className='tools_desc'>
                        <TaskAltOutlinedIcon /><span>Git, Github</span>
                    </div>
                </div>
                ...
                <div className='tools1'>
                    <div className='tools_desc'>
                        <TaskAltOutlinedIcon /><span>Postman</span>
                    </div>
                </div>
                <div className='tools1'>
                    <div className='tools_desc'>
        ...
        <div className='requirement'>
            ...
            <div className='skills'>
                ...
                <div className='subskills'>
                    ...
                    <h3>A computer with either Windows or Mac or Linux to install all the free software and tools needed to build your new apps.</h3>
                    </div>
                </div>
            </div>
            ...
            <div className='skills'>
                ...
                <div className='subskills'>
                    <div className='subskills1'>
                    <h3>Willingness to learn and excitement about the new programs you’re about to build.</h3>
                    </div>
                </div>
            </div>

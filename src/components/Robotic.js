...
const  Robotic = () => {
    const syllabusFile="../Syllabus/RPA.pdf";
    const handleDownload=()=>{
        const link = document.createElement('a');
        link.href = syllabusFile;
        link.download = 'RPA.pdf';
        link.click();
    };
  ...
  return (
    ...
    <section id='course'>
            ...
            <div className='syllabus_img'>
                <img src='https://www.fusion-institute.com/_next/image?url=https%3A%2F%2Fres.cloudinary.com%2Fdu45ucceq%2Fimage%2Fupload%2Fv1716961908%2FFusionCourseImage%2Frpa_cqcsau.jpg&w=640&q=75' alt='RPA (Robotic Process Automation)'></img>
            </div>

            <div className='Vertical_line' />

            <div className='syllabus_desc'>
                <h1>What is RPA (Robotic Process Automation)?</h1>
            <p>Robotic Process Automation (RPA) involves the use of software robots to automate repetitive, rule-based tasks traditionally performed by humans. RPA allows businesses to streamline operations, reduce errors, and increase efficiency by automating routine processes such as data entry, transaction processing, and report generation. By implementing RPA, organizations can focus on higher-value activities, enhance productivity, and achieve faster turnaround times. RPA is essential for companies looking to optimize their 
                workflows and maintain a competitive edge in an increasingly automated business environment.</p>
                <Link to="/demo">
            ...
            <div className='tools'>
                ...
                <div className='tools1'>
                    <div className='tools_desc'>
                        <TaskAltOutlinedIcon /><span>UiPath Studio</span>
                    </div>
                    </div>

                    <div className='tools1'>
                    <div className='tools_desc'>
                        <TaskAltOutlinedIcon /><span>Blue Prism</span>
                </div>
                </div>

                <div className='tools1'>
                    <div className='tools_desc'>
                        <TaskAltOutlinedIcon /><span>Kofax RPA</span>
                </div>
                </div>

                <div className='tools1'>
                    <div className='tools_desc'>
                        <TaskAltOutlinedIcon /><span>WorkFusion</span>
                </div>
                </div>

                <div className='tools1'>
                    <div className='tools_desc'>
                        <TaskAltOutlinedIcon /><span>Pega Robotics</span>
                </div>
                </div>

                <div className='tools1'>
                    <div className='tools_desc'>
                        <TaskAltOutlinedIcon /><span>AntWorks RPA</span>
                </div>
                </div>

                <div className='tools1'>
                    <div className='tools_desc'>
                        <TaskAltOutlinedIcon /><span>Redwood RPA</span>
                </div>
                </div>

                <div className='tools1'>
                    <div className='tools_desc'>
                        <TaskAltOutlinedIcon /><span>Appian RPA</span>
                </div>
                </div>
        ...
        <div className='requirement'>
            ...
            <div className='skills'>
                ...
                <div className='subskills'>
                    ...
                    <h3>Anyone who can wants to learn RPA (Robotic) to secure their career in the transforming business environment.</h3>
                    </div>
                </div>
            </div>
            ...
            <div className='skills'>
                ...
                <div className='subskills'>
                    <div className='subskills1'>
                    <h3>Anyone who wants to improve their chances of getting an RPA job.</h3>
                    </div>
                </div>
            </div>
            ...
            <div className='skills'>
                ...
                <div className='subskills'>
                    <div className='subskills1'>
                    <h3>Business users who want to learn and automate their business processes.</h3>
                    </div>
                </div>
            </div>

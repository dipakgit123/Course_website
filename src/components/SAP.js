...
const  SAP = () => {
    const syllabusFile="../Syllabus/SAP.pdf";
    const handleDownload=()=>{
        const link = document.createElement('a');
        link.href = syllabusFile;
        link.download = 'SAP.pdf';
        link.click();
    };
  ...
  return (
    ...
    <section id='course'>
            ...
            <div className='syllabus_img'>
                <img src='https://www.fusion-institute.com/_next/image?url=https%3A%2F%2Fres.cloudinary.com%2Fdu45ucceq%2Fimage%2Fupload%2Fv1716961935%2FFusionCourseImage%2FsapMM_cg44is.jpg&w=640&q=75' alt='SAP (Material Management)'></img>
            </div>

            <div className='Vertical_line' />

            <div className='syllabus_desc'>
                <h1>What is SAP (Material Management)?</h1>
            <p>Unlock the power of SAP Material Management (MM) to streamline procurement and inventory processes. Learn from industry experts through hands-on projects. Gain practical knowledge in master data management, procurement, and inventory optimization. Enhance proficiency in SAP MM functionalities and best practices for efficient material 
                management. Master SAP MM to drive effectiveness in your organization's operations.</p>
                <Link to="/demo">
    ...
    <section>
        <div className='container_tool'>
            ...
            <div className='tools'>
                ...
                <div className='tools1'>
                    <div className='tools_desc'>
                        <TaskAltOutlinedIcon /><span>SAP Learning Hub</span>
                </div>
                </div>

                <div className='tools1'>
                    <div className='tools_desc'>
                        <TaskAltOutlinedIcon /><span>Practice Datasets</span>
                </div>
                </div>

                <div className='tools1'>
                    <div className='tools_desc'>
                        <TaskAltOutlinedIcon /><span>Online Forums and Communities</span>
                </div>
                </div>

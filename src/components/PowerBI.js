...
const PowerBI = () => {
    ...
    const syllabusFile="../Syllabus/Power_BI.pdf";
    const handleDownload=()=>{
        const link = document.createElement('a');
        link.href = syllabusFile;
        link.download = 'Power_BI.pdf';
        link.click();
    };
  ...
  return (
    ...
    <section id='course'>
            ...
            <div className='syllabus_img'>
                <img src='https://www.fusion-institute.com/_next/image?url=https%3A%2F%2Fres.cloudinary.com%2Fdu45ucceq%2Fimage%2Fupload%2Fv1716961892%2FFusionCourseImage%2FpowerBI_b0antd.jpg&w=640&q=75' alt='power bi'></img>
            </div>
            ...
            <p> Unlock the potential of Power BI to analyze data, generate insights, 
                and drive informed decision-making. Gain hands-on experience and expert guidance to master this powerful business intelligence tool. Learn from industry professionals who bring real-world scenarios into the learning environment. Develop proficiency in data modeling, visualization, and dashboard creation using Power BI's intuitive interface. Dive deep into Power BI's advanced features, including DAX (Data Analysis Expressions) for complex calculations and measures. Work on practical projects that simulate real business challenges, allowing you to apply your skills in a realistic context. Enhance your ability to transform raw data into actionable insights, 
                empowering organizations to thrive in today's data-driven world.</p>
                <Link to="/demo">
            ...
            <div className='tools'>
                ...
                <div className='tools1'>
                    <div className='tools_desc'>
                        <TaskAltOutlinedIcon /><span>Power BI Desktop</span>
                    </div>
                    </div>
                ...
                <div className='tools1'>
                    <div className='tools_desc'>
                        <TaskAltOutlinedIcon /><span>Power BI Service</span>
                    </div>
                    </div>

                    <div className='tools1'>
                    <div className='tools_desc'>
                        <TaskAltOutlinedIcon /><span>Power BI Mobile App</span>
                    </div>
                </div>

                <div className='tools1'>
                    <div className='tools_desc'>
                        <TaskAltOutlinedIcon /><span>Power BI Gateway</span>
                    </div>
                </div>
        ...
        <div className='requirement'>
            ...
            <div className='skills'>
                ...
                <div className='subskills'>
                    ...
                    <h3>Microsoft Power BI Desktop (free download).</h3>
                    </div>
                </div>
            </div>
            ...
            <div className='skills'>
                ...
                <div className='subskills'>
                    <div className='subskills1'>
                    <h3>This course is designed for PC/Windows users (currently not available for Mac).</h3>
                    </div>
                </div>
            </div>
            ...
            <div className='skills'>
                ...
                <div className='subskills'>
                    <div className='subskills1'>
                    <h3>Experience with Excel Power Query and Power Pivot & DAX is a plus but not required.</h3>
                    </div>
                </div>
            </div>
        ...
        <div className='container_offering'>
            ...
            <div className='offering1'>
                <div className='course_offering'>
                    ...
                    <p><TaskAltOutlinedIcon />Course Duration: 3.5 Months</p>
                    <div className='vertical'/>

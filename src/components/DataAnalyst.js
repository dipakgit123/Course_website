...
const DataAnalyst = () => {
    ...
    const syllabusFile="../Syllabus/Data_Analyst.pdf";
    const handleDownload=()=>{
        const link = document.createElement('a');
        link.href = syllabusFile;
        link.download = 'Data_Analyst.pdf';
        link.click();
    };
  ...
  return (
    ...
    <section id='course'>
            ...
            <div className='syllabus_img'>
                <img src='https://www.fusion-institute.com/_next/image?url=https%3A%2F%2Fres.cloudinary.com%2Fdu45ucceq%2Fimage%2Fupload%2Fv1722000159%2FFusionCourseImage%2Fvorpzdopnlf4qvar3cy8.jpg&w=640&q=75' alt='data anaylst'></img>
            </div>

            <div className='Vertical_line' />

            <div className='syllabus_desc'>
                <h1>What is Data Analyst?</h1>
            <p> The Data Analyst course offers a deep dive into the essentials of data 
                analysis, focusing on practical skills and real-world application. 
                You will master data manipulation, exploration, and visualization using tools like Excel, SQL, and Python. The course covers data cleaning, statistical analysis, and machine learning basics, enabling you to uncover insights and drive business decisions. You'll also learn to create compelling visualizations and reports, ensuring your findings are clear and impactful. This course is designed to equip you with the skills needed for a successful career in data analysis.</p>
                <Link to="/demo">
            ...
            <div className='tools'>
                ...
                <div className='tools1'>
                    <div className='tools_desc'>
                        <TaskAltOutlinedIcon /><span>Excel</span>
                    </div>
                    </div>

                    <div className='tools1'>
                    <div className='tools_desc'>
                        <TaskAltOutlinedIcon /><span>SQL</span>
                </div>
                </div>

                <div className='tools1'>
                    <div className='tools_desc'>
                        <TaskAltOutlinedIcon /><span>Python</span>
                    </div>
                    </div>

                    <div className='tools1'>
                    <div className='tools_desc'>
                        <TaskAltOutlinedIcon /><span>Tableau</span>
                    </div>
                </div>
    ...
    <section>
        ...
        <div className='requirement'>
            ...
            <div className='skills'>
                ...
                <div className='subskills'>
                    <div className='subskills1'>
                    <h3>Ability to think logically and solve problems systematically.</h3>
                    </div>
                </div>
            </div>

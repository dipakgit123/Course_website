...
const DataScience = () => {
    ...
    const syllabusFile="../Syllabus/Data_Science.pdf";
    const handleDownload=()=>{
        const link = document.createElement('a');
        link.href = syllabusFile;
        link.download = 'Data_Science.pdf';
        link.click();
    };
  ...
  return (
    ...
    <section id='course'>
            ...
            <div className='syllabus_img'>
                <img src='https://www.fusion-institute.com/_next/image?url=https%3A%2F%2Fres.cloudinary.com%2Fdu45ucceq%2Fimage%2Fupload%2Fv1716961875%2FFusionCourseImage%2FdataScienceImage_lwwesn.jpg&w=640&q=75' alt='data science'></img>
            </div>
            ...
            <p> Master Data Science techniques to analyze and interpret complex data. Learn from industry-leading experts who provide practical, hands-on knowledge. Engage with a comprehensive curriculum covering data cleaning, preprocessing, advanced modeling, and predictive analytics. Work on real projects to apply your skills practically. Enhance your analytical abilities with training in statistical analysis, data visualization, and big data technologies. 
                Develop proficiency in tools like Python, R, SQL, and TensorFlow.</p>
                <Link to="/demo">
            ...
            <div className='tools'>
                <div className='tools1'>
                    <div className='tools_desc'>
                        <TaskAltOutlinedIcon /><span>Anaconda Framework</span>
                    </div>
                </div>
                <div className='tools1'>
                    <div className='tools_desc'>
                        <TaskAltOutlinedIcon /><span>Spyder</span>
                    </div>
                </div>
                <div className='tools1'>
                    <div className='tools_desc'>
                        <TaskAltOutlinedIcon /><span>Jupyter</span>
                    </div>
                </div>
                <div className='tools1'>
                    <div className='tools_desc'>
        ...
        <div className='container_offering'>
            ...
            <div className='offering1'>
                <div className='course_offering'>
                    ...
                    <p><TaskAltOutlinedIcon />Course Duration: 4.5 Months</p>
                    <div className='vertical'/>

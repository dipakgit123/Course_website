...
const ReactJS = () => {
    const syllabusFile="../Syllabus/React_JS.pdf";
    const handleDownload=()=>{
        const link = document.createElement('a');
        link.href = syllabusFile;
        link.download = 'React_JS.pdf';
        link.click();
    };
  ...
  return (
    ...
    <section id='course'>
            ...
            <div className='syllabus_img'>
                <img src='https://www.fusion-institute.com/_next/image?url=https%3A%2F%2Fres.cloudinary.com%2Fdu45ucceq%2Fimage%2Fupload%2Fv1716961898%2FFusionCourseImage%2Freactjs_yh8ldn.jpg&w=640&q=75' alt='React JS'></img>
            </div>
            ...
            <p> Master React.js for dynamic web applications. Learn hands-on with practical projects. Dive into React's component-based 
                architecture and JSX syntax. Explore state management, routing, and lifecycle methods. Enhance proficiency with modern JavaScript and popular libraries like React Router and Redux. Build scalable, interactive user interfaces. Whether a beginner or experienced developer, mastering React.js opens doors to powerful web development.</p>
                <Link to="/demo">
        ...
        <div className='container_tool'>
            ...
            <div className='tools'>
                ...
                <div className='tools1'>
                    ...
                    <div className='tools1'>
                    <div className='tools_desc'>
                        <TaskAltOutlinedIcon /><span>ESLint and Prettier</span>
                </div>
                </div>

                    <div className='tools1'>
                    <div className='tools_desc'>
                        <TaskAltOutlinedIcon /><span>Redux DevTool</span>
                    </div>
                </div>

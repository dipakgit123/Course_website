...
const  BigDataHadoop = () => {
    const syllabusFile="../Syllabus/Big_Data_Hadoop.pdf";
    const handleDownload=()=>{
        const link = document.createElement('a');
        link.href = syllabusFile;
        link.download = 'Big_Data_Hadoop.pdf';
        link.click();
    };
  ...
  return (
    ...
    <section id='course'>
            ...
            <div className='syllabus_img'>
                <img src='https://www.fusion-institute.com/_next/image?url=https%3A%2F%2Fres.cloudinary.com%2Fdu45ucceq%2Fimage%2Fupload%2Fv1716964505%2FFusionCourseImage%2FSAP_Fico_wdl8u6.jpg&w=640&q=75' alt='Big Data Hadoop'></img>
            </div>

            <div className='Vertical_line' />

            <div className='syllabus_desc'>
                <h1>What is Big Data Hadoop?</h1>
            <p>Big Data Hadoop is a powerful framework designed to store, process, and analyze massive volumes of data in a distributed computing environment. It consists of two main components: Hadoop Distributed File System (HDFS) for storage and MapReduce for processing. Hadoop enables organizations to handle large-scale data sets efficiently, extract valuable insights, and make data-driven decisions. It's widely used across industries for tasks like data warehousing, log processing, and machine learning. Mastering 
                Big Data Hadoop opens doors to opportunities in data engineering, analytics, and beyond.</p>
                <Link to="/demo">
            ...
            <div className='tools'>
                ...
                <div className='tools1'>
                    <div className='tools_desc'>
                        <TaskAltOutlinedIcon /><span>Hadoop Distributed File System</span>
                    </div>
                    </div>

                    <div className='tools1'>
                    <div className='tools_desc'>
                        <TaskAltOutlinedIcon /><span>MapReduce</span>
                </div>
                </div>

                <div className='tools1'>
                    <div className='tools_desc'>
                        <TaskAltOutlinedIcon /><span>YARN</span>
                </div>
                </div>

                <div className='tools1'>
                    <div className='tools_desc'>
                        <TaskAltOutlinedIcon /><span>Hadoop Ecosystem Tools</span>
                </div>
                </div>

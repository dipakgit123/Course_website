...
const Python = () => {
    const syllabusFile="../Syllabus/Python_Development.pdf";
    const handleDownload=()=>{
        const link = document.createElement('a');
        link.href = syllabusFile;
        link.download = 'Python_Development.pdf';
        link.click();
    };
  ...
  return (
    ...
    <section id='course'>
            ...
            <div className='syllabus_img'>
                <img src='https://www.fusion-institute.com/_next/image?url=https%3A%2F%2Fres.cloudinary.com%2Fdu45ucceq%2Fimage%2Fupload%2Fv1716964623%2FFusionCourseImage%2FPythonDevelopment_svql57.jpg&w=640&q=75' alt='Python Development'></img>
            </div>

            <div className='Vertical_line' />

            <div className='syllabus_desc'>
                <h1>What is Python Development?</h1>
            <p> Master Python development with hands-on projects and expert guidance. Dive deep into Python's powerful features and libraries. Learn fundamental concepts like data structures, algorithms, and object-oriented programming. Work on real-world projects to apply your skills practically. Enhance proficiency in Python frameworks like Django and Flask. Whether you're a beginner or experienced developer, 
                mastering Python opens doors to diverse opportunities in software engineering.</p>
                <Link to="/demo">
            ...
            <div className='tools'>
                ...
                <div className='tools1'>
                    <div className='tools_desc'>
                        <TaskAltOutlinedIcon /><span>PyCharm</span>
                    </div>
                    </div>

                    <div className='tools1'>
                    <div className='tools_desc'>
                        <TaskAltOutlinedIcon /><span>Visual Studio Code</span>
                </div>
                </div>

                    <div className='tools1'>
                    <div className='tools_desc'>
                        <TaskAltOutlinedIcon /><span>Package Managers</span>
                    </div>
                </div>

                <div className='tools1'>
                    <div className='tools_desc'>
                        <TaskAltOutlinedIcon /><span>Virtual Environments</span>
                    </div>
                </div>

                <div className='tools1'>
                    <div className='tools_desc'>
                        <TaskAltOutlinedIcon /><span>Git</span>
                    </div>
                </div>
                <div className='tools1'>
                    <div className='tools_desc'>
        ...
        <div className='requirement'>
            ...
            <div className='skills'>
                ...
                <div className='subskills'>
                    ...
                    <h3>There are no hard pre-requisites. Basic understanding of Computer Programming 
                        terminologies is sufficient. Also basic concepts related to Programming and Database is beneficial but not mandatory</h3>
                    </div>
                </div>
            </div>
